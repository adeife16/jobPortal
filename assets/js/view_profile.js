...
// console.log(averageRating);
		...
		if(userType === 'employee'){
			...
			$("#basic_details").html('<p><h2>'+data.first_name+' '+data.last_name+'</h2></p>	<p><h4></h4></p>	<p><i class="icon ion-ios-location"></i>'+data.lga_name+', '+data.state_name+'</p>');
