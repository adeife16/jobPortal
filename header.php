      ...
      <nav class="navbar navbar-expand-lg">
        <a class="navbar-brand" href="index.php">
          <span>
            ...
            <!--<h3 style="width: 70px;"><span class="color-blue">RES</span><span class="color-red">UME</span></h3>-->
             <h3 style="display: inline-flex; font-weight:bold;"><span class="color-red">RES</span> <span class="color-blue" id="change-color">UME</span></h3>
          </span>
        </a>
        ...
        <span class="notification" data-toggle="modal" data-target="#noticeModal"><i class="icon ion  ion-android-notifications-none" style="font-size: 40px; margin-left: 10px"></i> <span class="notify red color-white" id="notify"></span>
        </div>
      </div>
      <!--
      <div class="dropdown">
